...
--]] ---------------------------------------------------------
    ...
    function skin.gradient(object)
        ...
        local imagecolor = object.color or skin.controls.color_image

        love.graphics.setColor(imagecolor)
        love.graphics.draw(mesh, x, y, orientation, width, height)
    end
...
--]] ---------------------------------------------------------
    function skin.panel(object)
        ...
        local width = object:GetWidth()
        local height = object:GetHeight()
        local bornerRadius = object:GetBorderRadius()
...
--]] ---------------------------------------------------------
    ...
    subskin.controls.color_back0 = color "#202020"
    subskin.controls.color_back1 = color "#303030"
    subskin.controls.color_back2 = color "#474747"
